...
#ifndef SOCKET_IPV6_H
#define SOCKET_IPV6_H
...
public:
   ...
   * @throws SocketException on fail.
   */
  void connect(const SocketAddressIPv6 &addr) throw(SocketException);
  /**
   * Closes socket.
   * @throws SocketException on fail.
   */
   ...
   * @throws SocketException on fail.
   */
  void bind(const SocketAddressIPv6 &addr) throw(SocketException);
  /**
   ...
   */
  SocketIPv6 *accept() throw(SocketException);
   ...
   */
  bool getLocalAddr(SocketAddressIPv6 *addr);
  /**
   * Returns peer address.
   * @param addr output parameter that will contain socket address.
   * @return true on success, false on fail.
   */
  bool getPeerAddr(SocketAddressIPv6 *addr);
...
protected:
  ...
  SOCKET getAcceptedSocket(struct sockaddr_in6 *addr);
  ...
  SocketAddressIPv6 *m_localAddr;
  SocketAddressIPv6 *m_peerAddr;
